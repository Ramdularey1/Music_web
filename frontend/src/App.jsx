      ...
      <BrowserRouter>
        <Routes>
          <Route element={<RootLayout />}>
            ...
            <Route path="/SpanishSong" element={<SpanishSong />} />
            <Route path="/SouthSong" element={<SouthSong />} />
            <Route path="/MotivationalSong" element={<MotivationalSong />} />
            <Route path="/PunjabiSong" element={<PunjabiSong />} />
            <Route path="/RomanticSong" element={<RomanticSong />} />
            <Route path="/TopMusic" element={<TopMusic />} />
            <Route path="/ArjitSingh" element={<ArjitSingh />} />
            <Route path="/UditNarayan" element={<UditNarayan />} />
            <Route path="/KumarSanu" element={<KumarSanu />} />
            <Route path="/AbhijeetSong" element={<AbhijeetSong />} />
            <Route path="/KkSong" element={<KkSong />} />
            <Route path="/HoneySinghSong" element={<HoneySinghSong />} />
            <Route path="/BadshahSong" element={<BadshahSong />} />
          </Route>
          <Route element={<AuthLayout />}>
            <Route path="/auth" element={<Registration />} />
            <Route path="/login" element={<Login />} />
